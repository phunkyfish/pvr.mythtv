...
macro (build_addon target prefix libs)
  ...
  ELSE(PACKAGE_ZIP OR PACKAGE_TGZ)
    ...
    set(CMAKE_INSTALL_LIBDIR "${CMAKE_INSTALL_LIBDIR}/${APP_NAME_LC}")
    message(STATUS "Setting install paths to: ${CMAKE_INSTALL_LIBDIR}")
    INSTALL(TARGETS ${target} DESTINATION ${CMAKE_INSTALL_LIBDIR}/addons/${target})
    INSTALL(DIRECTORY ${target} DESTINATION ${CMAKE_INSTALL_PREFIX}/share/${APP_NAME_LC}/addons PATTERN "addon.xml.in" EXCLUDE)
...
set(USED_SOURCES ${MYTHTV_HEADERS} ${MYTHTV_SOURCES})
file(STRINGS ${PROJECT_SOURCE_DIR}/lib/kodi/pvr/versions.h BIN_ADDON_PARTS)
